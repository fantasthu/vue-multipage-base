        ...
        <div class="work-list flex-h" v-for="item,index in workList">
          ...
          <div class="right-wrap flex-1 flex-v">
            ...
            <div class="flex-h btns-wrap">
              <div class="flex-h">
                <div class="unsolved tag" v-if="item.status==='0'">未解决</div>
                <div class="solved tag" v-if="item.status==='1'">已解决</div>
                <div class="suggest tag flex-h flex-cc" v-if="item.ordertype==='0'"><img src="../assets/img/face-happy.png" alt="">建议</div>
                <div class="suggest tag flex-h flex-cc" v-if="item.ordertype==='1'"><img src="../assets/img/face-sad.png" alt="">客诉</div>
              </div>
              <div class="btns-hide">
